...
## [1.2.7](https://github.com/zkMIPS/cc-rs/compare/cc-v1.2.6...cc-v1.2.7) - 2025-01-03

### Other

- Make is_flag_supported_inner take an &Tool ([#1337](https://github.com/zkMIPS/cc-rs/pull/1337))
- Fix is_flag_supported on msvc ([#1336](https://github.com/zkMIPS/cc-rs/pull/1336))
- Allow using Visual Studio target names in `find_tool` ([#1335](https://github.com/zkMIPS/cc-rs/pull/1335))
